...
/******/ (() => {
  ...
  \************************************************/
            /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                const { TextElement, RolePill, DiscordConstants, rolePill } = __webpack_require__(
  ...
  \***************************************/
            /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                /* harmony import */ var _UserMentionsComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
                    /*! ./UserMentionsComponent */ './src/components/UserMentionsComponent.jsx'
                );
                /* harmony import */ var _ChannelRolesComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
                    /*! ./ChannelRolesComponent */ './src/components/ChannelRolesComponent.jsx'
                );
                /* harmony import */ var _AdminRolesComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
                    /*! ./AdminRolesComponent */ './src/components/AdminRolesComponent.jsx'
                );
                /* harmony import */ var _ForumComponent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
                    /*! ./ForumComponent */ './src/components/ForumComponent.jsx'
                );
                /* harmony import */ var _utils_date__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
                        ...
                        BdApi.React.createElement(
                            ...
                            channel.rateLimitPerUser > 0 &&
                                BdApi.React.createElement(
                                    ...
                                    'Slowmode: ',
                                    (0, _utils_date__WEBPACK_IMPORTED_MODULE_4__.convertToHMS)(channel.rateLimitPerUser)
                                ),
                            channel.nsfw &&
                                BdApi.React.createElement(
                                    TextElement,
                            ...
                            BdApi.React.createElement(
                                ...
                                'Created on: ',
                                (0, _utils_date__WEBPACK_IMPORTED_MODULE_4__.getDateFromSnowflake)(channel.id)
                            ),
                            channel.lastMessageId &&
                                BdApi.React.createElement(
                                    ...
                                    'Last message sent: ',
                                    (0, _utils_date__WEBPACK_IMPORTED_MODULE_4__.getDateFromSnowflake)(channel.lastMessageId)
                                ),
                            settings['showPerms'] &&
            ...
            /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                function UserMentionsComponent({ channel, guild, settings }) {
                    ...
                    const fetchMemberAndMap = async () => {
                        ...
                        const allUserOverwrites = Object.values(channel.permissionOverwrites).filter((user) =>
            ...
            /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                const Route =
                    ...
                    WebpackModules?.getModule((m) =>
                        m?.default?.toString().includes('"impressionName","impressionProperties","disableTrack"')
                    );
                          ...
                          Patch() {
                              ...
                              Patcher.after(ChannelStore, 'getMutableGuildChannelsForGuild', (_, [guildId], GuildChannels) => {
                                  ...
                                  const GuildCategories =
                                      GuildChannelsStore.getChannels(guildId)[DiscordConstants.ChannelTypes.GUILD_CATEGORY];
